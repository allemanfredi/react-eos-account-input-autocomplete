...
const getAccounts = async (_rpc, _currentTypedAccount, _currentAccounts, _limit) => {
...
const EosAccountInputAutoComplete = _props => {
  ...
  const rpc = typeof _props.rpc === 'string' ? new JsonRpc(_props.rpc, {
    fetch
  }) : _props.rpc;
  return /*#__PURE__*/React.createElement("div", {
    ...
    onChange: _e => {
      ...
      getAccounts(rpc, _e.target.value, accounts, _props.limit ? _props.limit : 10).then(_accounts => {
        if (_props.onFetchAccounts) _props.onFetchAccounts(_accounts);
        setAccounts(_accounts);
      });
    }
  }), accounts && accounts.length > 0 && isFocused ? /*#__PURE__*/React.createElement("div", {
